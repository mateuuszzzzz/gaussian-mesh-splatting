...
from hypercloud.models import aae

from hypercloud.utils.pcutil import plot_3d_point_cloud
from hypercloud.utils.util import find_latest_epoch, prepare_results_dir, cuda_setup, setup_logging, set_seed, get_weights_dir
from hypercloud.utils.points import generate_points
...
def main(config):
    ...
    if True:
        from hypercloud.datasets.shapenet import ShapeNetDataset
        dataset = ShapeNetDataset(root_dir='/home/mateusz/datasets/ds',
    ...
    if config['reconstruction_loss'].lower() == 'chamfer':
        from hypercloud.losses.champfer_loss import ChamferLoss
        ...
        from hypercloud.losses.earth_mover_distance import EMD
...
def sphere_triangles(encoder, hyper_network, device, x, results_dir, amount, method, depth, start, end, transitions):
    from hypercloud.utils.sphere_triangles import generate
